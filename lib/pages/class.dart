...
return originalListTilesDataMonday.indexOf(a).compareTo(originalListTilesDataMonday.indexOf(b));
}
});
});
}
...
ListTileData({required this.title, required this.isChecked, required this.isLocked});
}